...
SELECT v.name, v.classification, v.amount FROM (VALUES
  ...
  ('Alimentos',          'shared', 600000),
  ('Arriendo',           'shared', 800000),
  ('Jardin',             'shared', 450000),
  ('Auto (cuota)',       'shared', 472000),
  ('Restaurantes',       'shared', 250000),
  ('Remesas',            'shared', 350000),
  ('GGCC',               'shared', 100000),
...
FROM (VALUES
  ...
  ('alimentos',     'contains', 'Alimentos',  'Alimentos',  10),
  ('alimento',      'contains', 'Alimentos',  'Alimentos',  10),
  ('comida',        'contains', 'Alimentos',  'Alimentos',  10),
  ('mercado',       'contains', 'Alimentos',  'Alimentos',  10),
  ('feria',         'contains', 'Alimentos',  'Alimentos',  10),
  ('verdura',       'contains', 'Alimentos',  'Alimentos',  10),
  ...
  ('almuerzo',      'contains', 'Restaurantes',       'Restaurantes',       10),
  ('delivery',      'contains', 'Restaurantes',       'Restaurantes',       10),
  -- \y = límite de palabra: evita que 'cena' matchee "docena"/"escena"
  ('\ycenas?\y',    'regex',    'Restaurantes',       'Restaurantes',       10),
  ('remesa',        'contains', 'Remesas',  'Remesas',  10),
  ('venezuela',     'contains', 'Remesas',  'Remesas',  10),
